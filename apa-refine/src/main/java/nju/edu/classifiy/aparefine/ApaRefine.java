 ...
 */
public class ApaRefine {
    public static final String OUTPUT_PATH = "aparefine";

    public static void main(String[] args) {
        if (args.length != 2) {
            System.err.printf("Usage: " + ApaRefine.class.toString() + " [tablename] [output path]");
            System.exit(-1);
        }
        ...
        job.setJarByClass(ApaRefine.class);
        ...
        job.setReducerClass(ApaReducer.class);
